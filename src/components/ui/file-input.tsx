...
export function FileInput({ accept, onChange, label = "Choose file", className }: FileInputProps) {
  ...
  return (
    <div className={cn("w-full", className)}>
      ...
      >
        <svg className="h-5 w-5 text-foreground-faint" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
          <path d="M4 13v2a2 2 0 002 2h8a2 2 0 002-2v-2M12 6v7m0-7l-2.5 2.5M12 6l2.5 2.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
