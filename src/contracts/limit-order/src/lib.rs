...
pub enum Error {
    ...
    UnknownError = 54,
    OrderNotFoundInBook = 55,
    OrderSideMismatch = 56,
    OrderPriceMismatch = 57,
    OrderAmountMismatch = 58,
    OrderPairMismatch = 59,
    OrderOwnerMismatch = 60,
    OrderExpiryMismatch = 61,
    OrderFillRoundingError = 62,
    OrderRemainderTooSmall = 63,
    OrderSelfTrade = 64,
    OrderCrossingBook = 65,
    OrderPriceCrossesSpread = 66,
    OrderMatchingLoopLimit = 67,
    OrderSettlementDelayed = 68,
    OrderSettlementRejected = 69,
    OrderSettlementTimedOut = 70,
    OrderCancellationRejected = 71,
    OrderCancellationTimedOut = 72,
    OrderCancellationPending = 73,
    OrderModificationForbidden = 74,
    OrderModificationTimedOut = 75,
    OrderReplacementRejected = 76,
    OrderReplacementExpired = 77,
    OrderClaimRejected = 78,
    OrderClaimAlreadyProcessed = 79,
    OrderClaimExpired = 80,
    RelayerCommissionInvalid = 81,
    RelayerCommissionExceeded = 82,
    RelayerPayoutFailed = 83,
    RelayerPayoutPending = 84,
    RelayerBondInsufficient = 85,
    RelayerBondSlashed = 86,
    RelayerHeartbeatMissed = 87,
    RelayerReputationLow = 88,
    RelayerNotAuthorizedForPair = 89,
    FeeSnapshotMissing = 90,
    FeeSnapshotStale = 91,
    FeeRecalculationFailed = 92,
    FeeSplitInvalid = 93,
    FeeReceiverBlacklisted = 94,
    GasBufferExhausted = 95,
    GasEstimateFailed = 96,
    GasRefundFailed = 97,
    PathCycleDetected = 98,
    PathTooComplex = 99,
    OrderBookLocked = 100,
}
