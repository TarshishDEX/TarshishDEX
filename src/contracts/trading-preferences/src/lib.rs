...
pub enum Error {
    ...
    BatchTooLarge = 9,
    AccountNotFound = 10,
    InvalidPreferenceValue = 11,
    StorageFull = 12,
    MigrationInProgress = 13,
    ContractPaused = 14,
    PreferenceLimitReached = 15,
    InvalidAddress = 16,
    NetworkMismatch = 17,
    SignatureExpired = 18,
    OperationForbidden = 19,
    StorageReadError = 20,
    StorageWriteError = 21,
    TTLExpired = 22,
    DuplicateEntry = 23,
    ValidationFailed = 24,
    AdminOnly = 25,
    ...
    MinBpsNotMet = 27,
    AssetBlacklisted = 28,
    AssetNotRecognized = 29,
    WhitelistRequired = 30,
    BatchSizeExceeded = 31,
    PaginationOverflow = 32,
    CursorExpired = 33,
    ConcurrentModification = 34,
    StateCorrupted = 35,
    UpgradeRequired = 36,
    NotUpgradable = 37,
    InvalidVersion = 38,
    DeprecatedMethod = 39,
    GasLimitExceeded = 40,
    ReadOnlyViolation = 41,
    PausedGlobally = 42,
    EmergencyShutdown = 43,
    CircuitBreakerTripped = 44,
    RateLimitExceeded = 45,
    QuotaExceeded = 46,
    ResourceExhausted = 47,
    TimeoutError = 48,
    UnknownError = 49,
    PreferenceConflict = 50,
    SlippageTooLow = 51,
    SlippageTooHigh = 52,
    RoutingModeUnavailable = 53,
    BridgeRouteUnavailable = 54,
    DirectRouteUnavailable = 55,
    AssetPairUnsupported = 56,
    AssetPairBlacklisted = 57,
    MaxAssetsPerAccountExceeded = 58,
    AssetAllowlistEmpty = 59,
    AssetAllowlistFull = 60,
    AssetAlreadyAllowed = 61,
    AssetNotAllowed = 62,
    AssetRemovalForbidden = 63,
    SelfTradePreventionViolation = 64,
    DefaultPreferenceLocked = 65,
    PreferenceUpdateRejected = 66,
    PreferenceFreezeActive = 67,
    PreferenceExpired = 68,
    PreferenceRevoked = 69,
    PreferenceAlreadyExists = 70,
    PreferenceOwnershipMismatch = 71,
    PreferenceSchemaMismatch = 72,
    PreferenceVersionTooOld = 73,
    PreferenceVersionTooNew = 74,
    PreferenceChecksumMismatch = 75,
    PreferenceEncryptionRequired = 76,
    PreferenceDecryptionFailed = 77,
    PreferenceSerializationError = 78,
    PreferenceDeserializationError = 79,
    PreferenceStorageCorrupted = 80,
    PreferenceArchiveFull = 81,
    PreferenceRestoreFailed = 82,
    PreferenceBackupFailed = 83,
    PreferenceSnapshotStale = 84,
    PreferenceSnapshotMissing = 85,
    PreferenceMigrationFailed = 86,
    PreferenceRollbackFailed = 87,
    PreferenceRollbackNotAllowed = 88,
    PreferenceUpgradeInProgress = 89,
    PreferenceDowngradeForbidden = 90,
    PreferenceAdminLocked = 91,
    PreferenceDelegateExpired = 92,
    PreferenceDelegateNotAuthorized = 93,
    PreferenceQuorumNotReached = 94,
    PreferenceVoteAlreadyCast = 95,
    PreferenceVoteRejected = 96,
    PreferenceProposalNotFound = 97,
    PreferenceProposalExpired = 98,
    PreferenceProposalExecuted = 99,
    PreferenceRegistryPaused = 100,
}
