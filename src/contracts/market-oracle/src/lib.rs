...
pub enum Error {
    ...
    PriceDeviationTooHigh = 11,
    StaleDataThreshold = 12,
    DataFeedPaused = 13,
    InvalidResolution = 14,
    PriceSourceUnavailable = 15,
    MissingRequiredPair = 16,
    DuplicateObservation = 17,
    TimestampOutOfOrder = 18,
    ConfidenceIntervalTooWide = 19,
    PriceManipulationDetected = 20,
    FeedAuthorizationExpired = 21,
    InvalidSignature = 22,
    CorruptedData = 23,
    PublisherLimitReached = 24,
    PublisherNotActive = 25,
    UnsupportedAsset = 26,
    PriceFeedStopped = 27,
    UpdateFrequencyExceeded = 28,
    MinUpdateIntervalViolation = 29,
    DataConsistencyError = 30,
    OracleMismatch = 31,
    TrustedSourceRequired = 32,
    CircuitBreakerActivated = 33,
    VolatilityThresholdExceeded = 34,
    SuspiciousActivity = 35,
    AccessDenied = 36,
    WriteLockHeld = 37,
    ReadQuorumNotReached = 38,
    WriteQuorumNotMet = 39,
    HistoricalDataPruned = 40,
    ArchiveCorrupted = 41,
    StorageQuotaExceeded = 42,
    DiskFull = 43,
    IndexOutOfBounds = 44,
    DecimalPrecisionLoss = 45,
    RoundingError = 46,
    NegativePriceDetected = 47,
    ZeroVolumeDetected = 48,
    PairNotSupported = 49,
    FeedDeprecated = 50,
    PublisherBlacklisted = 51,
    PublisherNotWhitelisted = 52,
    PublisherStakeInsufficient = 53,
    PublisherSlashPending = 54,
    PublisherSlashed = 55,
    PublisherRewardClaimed = 56,
    PublisherRewardFailed = 57,
    PublisherHeartbeatMissed = 58,
    PublisherHeartbeatTimeout = 59,
    PublisherReputationLow = 60,
    PublisherReputationZero = 61,
    PublisherUnknown = 62,
    PublisherAlreadyRegistered = 63,
    PublisherRegistrationClosed = 64,
    PublisherDeregistrationPending = 65,
    PublisherDeregistrationDenied = 66,
    FeedAlreadyExists = 67,
    FeedNotFound = 68,
    FeedAlreadyPaused = 69,
    FeedAlreadyResumed = 70,
    FeedNotPaused = 71,
    FeedExpired = 72,
    FeedRevoked = 73,
    FeedUnderMaintenance = 74,
    FeedApprovalPending = 75,
    FeedApprovalRejected = 76,
    FeedApprovalExpired = 77,
    FeedApprovalRevoked = 78,
    FeedParameterInvalid = 79,
    FeedParameterOutOfRange = 80,
    FeedUpdateRejected = 81,
    FeedUpdateStale = 82,
    FeedUpdateFuture = 83,
    FeedUpdateDuplicated = 84,
    FeedUpdateConflicting = 85,
    FeedUpdateUnauthorized = 86,
    AggregationWindowElapsed = 87,
    AggregationTimeout = 88,
    AggregationEmpty = 89,
    AggregationInsufficient = 90,
    AggregationOutlierDetected = 91,
    AggregationConsensusFailed = 92,
    AggregationMedianOverflow = 93,
    AggregationWeightMismatch = 94,
    AggregationSourceCountMismatch = 95,
    SignatureThresholdNotMet = 96,
    SignatureSchemeUnsupported = 97,
